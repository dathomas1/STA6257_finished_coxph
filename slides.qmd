...
-   Can accont for "realistic" outcomes of observations (i.e., the patient surviving)
...
$$ HR = {h_{pre}(t) \over h_{post}(t)} = {h_0(t)\times exp(0.0177 \times X_{pre}) \over h_0(t) \times exp(0.0177 \times X_{post})} $$ $$ = {exp(0.0177 \times 1) \over exp(0.0177 \times 0)} = 1.018$$
Similar to Odds Ratio in that: 
