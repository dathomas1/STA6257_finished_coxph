...
kable(a,
  ...
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = TRUE, font_size = 20) %>%
...
ggpairs(va_subset, title = "Figure 1: Scatterplot Matrix of VA Lung Trial Data for Standard (1) and Test (2)", 
...
![Kaplan-Meier Survival Curve](index_files/figure-html/unnamed-chunk-7-1.png)
